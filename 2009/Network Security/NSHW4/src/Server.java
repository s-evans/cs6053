...
class ConnectionHandler extends MessageParser implements Runnable
{
    ...
    public ConnectionHandler (Socket i, int c, String name, String password, PrintWriter logWriter)
    {
        ...
        //team idents
        approvedTransferIdents = new String[] {"NEO", "JOHNCONNOR", "REBELATTACK"};
                ...
                if(expectedCmd.equals(cmd) || expectedCmd2.equals(cmd))
                {
                    ...
                    if(cmd.equals("IDENT"))
                    {
                        ...
                        else
                        {
                            ...
                            if(DEBUG)
                                System.out.println(IDENT + " (Server): NOT MATCHING CHECKSUM!!!\n");
...
*/
                    ...
                    else if(cmd.equals("SUBSET_A"))
                    {
                        ...
                        try
                        {
                            SendIt("SUBSET_A " + transferSubsetAString, out);
                        }
                        catch(IOException e)
                        {
                            e.printStackTrace(System.out);
                    ...
                    else if(cmd.equals("TRANSFER_RESPONSE"))
                    {
                        ...
                        try
                        {
                            ...
                            if(passCheck)
                            {
                                ...
                                SendIt("TRANSFER_RESPONSE ACCEPT", out);
                            ...
                            else
                            {
                                ...
                                SendIt("TRANSFER_RESPONSE DECLINE", out);
