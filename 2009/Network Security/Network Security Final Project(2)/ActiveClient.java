    ...
    public void run()
    {
        ...
        while(Thread.currentThread() == runner)
        {
            ...
            try
            {
                ...
                //CHANGE_PASSWORD here!!! to something random???
                ...
                if(expectedCmd.equals(cmd) || expectedCmd2.equals(cmd))
                {
                    ...
                    else if(cmd.equals("WAITING"))
                    {
                        ...
                        try
                        {
                            ...
                            SendIt("MAKE_CERTIFICATE " + publicV.toString(32) + " " + monitorNInt.toString(32));
                        ...
                        if(GetNextCommand(msg, "RESULT").equals("CERTIFICATE"))
                        {
                            ...
                            if(DEBUG)
                                System.out.println(IDENT + " (Client): Certificate = " + myCert + "|END\n");
...
System.out.println(IDENT + " (Client): publicKeyV = " + publicV + "|END");
System.out.println(IDENT + " (Client): publicKeyN = " + monitorNInt + "|END\n");

                    SendIt("PUBLIC_KEY " + publicV.toString(32) + " " + monitorNInt.toString(32));
                ...
                else if(cmd.equals("AUTHORIZE_SET"))
                {
                    ...
                    if(numRounds >= 20)
                    {
                        ...
                        for(int lcv = 0; lcv < numRounds; lcv++)
                        {
                            ...
                            randomBigInt.modPow(new BigInteger("2"), monitorNInt);

                            //build authorize set string
                            transferAuthorizeSetString += randomBigInt.toString() + " ";
                        ...
                        //send authorize set
                        SendIt("AUTHORIZE_SET " + transferAuthorizeSetString);
                ...
                else if(cmd.equals("SUBSET_K"))
                {
                    ...
                    for(int lcv = 0; lcv < numRounds; lcv++)
                    {
                        ...
                        if(transferSubsetAString.indexOf(" " + lcvString + " ") != -1)
                        {
                            ...
                            BigInteger kValue = new BigInteger(transferAuthorizeSet[lcv]);

                            //K = (secret * authorizeset) mod n
                            kValue = kValue.multiply(secretS);
                            kValue = kValue.mod(monitorNInt);

                            transferSubsetKString += kValue.toString() + " ";
                        ...
                        else
                        {
                            ...
                            BigInteger jValue = new BigInteger(transferAuthorizeSet[lcv]);

                            //J = authorizeset mod n
                            jValue = jValue.mod(monitorNInt);

                            transferSubsetJString += jValue.toString() + " ";
                    ...
                    //send SUBSET_K
                    SendIt("SUBSET_K " + transferSubsetKString);
                ...
                else if(cmd.equals("SUBSET_J"))
                {
                    ...
                    //send SUBSET_J
                    SendIt("SUBSET_J " + transferSubsetJString);
