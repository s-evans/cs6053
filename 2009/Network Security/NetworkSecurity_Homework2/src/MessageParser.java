   ...
   { 
      ...
      if (CType == 0)
      {
          ...
          { 
            ...
            String PassReturn = GetMonitorMessage();
            StringTokenizer j;
            j = new StringTokenizer(PassReturn, " :\n");
            String lookfor = "PASSWORD";
            //Search for the Password
            String t = j.nextToken();
            
            while (!(t.trim().equals(lookfor.trim()))) t = j.nextToken();
            t = j.nextToken();
            System.out.println("MY COOKIE!: " + t);
