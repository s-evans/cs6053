...
// RCS       :
//
// $Source: /home/franco/CVS/Courses/C653/Homework/FrancoMonitor/Project/DHEngine.java,v $
// $Revision: 1.1 $
...
// *** empty log message ***
//
// Revision 1.3  2009/04/16 19:49:15  franco
// *** empty log message ***
//
// Revision 1.2  2009/04/16 19:47:29  franco
// *** empty log message ***
//
 ...
 *
 * How to use:
 *  a.  Instantiate one. - Feed it the offical DHKey 
...
class DHEngine {
    ...
    private DHKey key;        /* Heres the basic Key gadget */
    ...
    private DHKey MakeKey(int size, int quality) { 
	...
	System.out.println("Initializing DHEngine ");
        ...
        return(new DHKey(n,g,"DHEngine $Revision: 1.1 $/"+keysize));
    }
