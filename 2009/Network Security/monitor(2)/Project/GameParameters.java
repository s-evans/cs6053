...
// RCS       :
//
// $Source: /home/franco/CVS/Courses/C653/Homework/FrancoMonitor/Project/GameParameters.java,v $
// $Revision: 1.2 $
// $Date: 2009/04/24 19:51:26 $
//
// $Log: GameParameters.java,v $
// Revision 1.2  2009/04/24 19:51:26  franco
// *** empty log message ***
//
// Revision 1.1  2009/04/22 11:21:10  franco
// *** empty log message ***
//
// Revision 1.2  2009/04/16 19:43:46  franco
// *** empty log message ***
//
...
class GameParameters {
   static final String rcsid = "$Revision: 1.2 $";
   ...
   static final String MONITOR_VERSION = "2.2";
   ...
   public static final double INCOMING_CONNECTION_TIMEOUT = 30.0 * 60.0;
   ...
   public static final int    MAX_COMMAND_RETRY_ON_REQUIRE =
                                                    MAX_COMMAND_RETRY / 2;
   ...
   static final double SECONDS_ALIVE_FOR_RESOURCES = 60.0 * 1.0;
   ...
   public static final int MAX_CONNECTIONS_PER_PERIOD = 120;
   /**********************************************************************/
   /* Recurring event timers         */
   
   public static final double CHECK_FOR_LIVING_MINIMUM_TIME = 1.0 * 60.0;
   public static final double CHECK_FOR_LIVING_MAXIMUM_TIME = 2.0 * 60.0;

   public static final double WAR_RUNNER_MINIMUM_TIME = 5.0 * 60.0;
   public static final double WAR_RUNNER_MAXIMUM_TIME = 5.0 * 60.0;
   
   public static final double AWARD_RESOURCES_TIME = 65.0 * 1.0;
   ...
   public static final int ALLOTMENT_AMOUNT_TO_GIVE = 140;
   ...
   static final String SERVICE_CONTACT = "project@helios.ececs.uc.edu";
}
