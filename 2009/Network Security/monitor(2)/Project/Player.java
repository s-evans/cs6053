...
// RCS       :
//
// $Source: /home/franco/CVS/Courses/C653/Homework/FrancoMonitor/Project/Player.java,v $
// $Revision: 1.1 $
...
class Player implements Serializable {
   ...
   Hashtable wars;
   int warsFought, warsDeclared, warsTruce, warsLost, warsWon;
   ...
   Player(String who, Economy economy) {
      ...
      wars = new Hashtable();
      warsFought = warsDeclared = warsTruce = warsLost = warsWon = 0;
   ...
   public synchronized boolean awardResources() {
      ...
      if (give)
         ...
         wealth.allocateResourcesToMonitor();
