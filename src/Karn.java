...
public class Karn {
    ...
    /**
     * Initializes a new Karn encryption class Creates a random source of
     * SecureRandom and defines a SHA message digest
     * 
     * @param bi
     *            Key represented as a BigInteger
     */
    public Karn(BigInteger bi) {
        ...
        try {
            ...
            System.out.println("Karn [Karn]: NoSuchAlgorithmException:\n\t" + e + " " + this);
        }
    }
    ...
    /**
     * Decrypt the ciphertext by running Karn in reverse Takes a base32 encoded
     * stream with guard byte and padding Outputs the decrypted plaintext
     */
     ...
     * 
     * @param ciphertext
     *            Probable base32 encoded cipher text
     */
